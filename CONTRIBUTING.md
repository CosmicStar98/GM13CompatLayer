# Contributing to GM13CompatLayer

Thank you for considering contributing to GM13CompatLayer! We appreciate all types of contributions, including bug fixes, new features, and documentation improvements.
...
Pull requests should ideally do one thing in one place. Avoiding opening massive pull requests that change multiple components at once. These are often not reviewable and result in unmanageable conflicts with other active PRs.
...
Code formatting is defined by [these style guidelines](https://github.com/CFC-Servers/cfc_glua_style_guidelines).
